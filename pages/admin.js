...
export default function Admin() {
    ...
    const handlecatDeleteClick = async () => {
        try {
            const response = await fetch('/api/catDeleteada', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    ...
                    <td>
                        <fieldset className={styles.adminList}>
                            ...
                            <form>
                                ...
                                <input type="text" id="newCategory" name="newCategory" pattern="^[\w\- ]+$" value={newCategory} onChange={handleNewCategoryChange} required />
                    ...
                    <td>
                        <fieldset className={styles.adminList}>
                            ...
                            <form>
                                ...
                                <input type="text" id="catUpdate" name="catUpdate" pattern="^[\w\- ]+$" value={catUpdate} onChange={handlecatUpdateChange} required />
                    ...
                    <td>
                        <fieldset className={styles.adminList}>
                            ...
                            <form>
                                ...
                                <label className={styles.label}>Name *</label>
                                <input type="text" id="productName" name="productName" pattern="^[\w\- ]+$" onChange={handleNewProduct} required />
                                <label className={styles.label}>Price *</label>
                                <input type="number" id="productPrice" name="productPrice" pattern="^\d+\.?\d*$" onChange={handleNewProduct} required />
                                <label className={styles.label}>Inventory *</label>
                                <input type="number" id="productInventory" name="productInventory" pattern="^\d*$" onChange={handleNewProduct} required />
                                <label className={styles.label}>Description *</label>
                                <textarea type="text" id="productDescription" name="productDescription" pattern="^[\w\- ]+$" onChange={handleNewProduct} required />
                    ...
                    <td>
                        <fieldset className={styles.adminList}>
                            ...
                            <form>
                                ...
                                {updateItem === "name" && (
                                    <input className={styles.textMargin} type="text" pattern="^[\w\-]+$" id="updateValue" name="updateValue" onChange={handleUpdateValueChange} required />
                                )}
                                {updateItem === "price" && (
                                    <input className={styles.textMargin} type="number" pattern="^\d+\.?\d*$" id="updateValue" name="updateValue" onChange={handleUpdateValueChange} required />
                                )}
                                {updateItem === "inventory" && (
                                    <input className={styles.textMargin} type="number" pattern="^\d*$" id="updateValue" name="updateValue" onChange={handleUpdateValueChange} required />
                                )}
                                {updateItem === "description" && (
                                    <textarea className={styles.textMargin} id="updateValue" pattern="^[\w\-]+$" name="updateValue" onChange={handleUpdateValueChange} required />
                                )}
                                {updateItem === "image" && (
